...
---
<p></p>
In Cap, we  exploited a Python sandbox to execute code, got a reverse shell, retrieved SSH credentials from the database, and bypassed a backup filter to grab the root flag.
...
<img src="/images/Code/code_python_jail.png" alt="python sandbox" class="postImage">
...
<img src="/images/Code/code_crackstation.png" alt="cracked password for martin" class="postImage">
...
<p>In martin's home directory, we find an intersting json file:</p>
<pre>
{
...
<p>Next, investigated whether we can run anything as sudo</p>
<pre>
sudo -l
